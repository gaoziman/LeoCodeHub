package org.leocoder.codehub.web.config;
...
public class Knife4jWebConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("org.leocoder.codehub.web.controller"))
